...
> **Note:** The Container App will use managed identity authentication. ACR pull permissions are automatically granted during infrastructure deployment (Step 6).
